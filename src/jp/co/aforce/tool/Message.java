...
public class Message {
	...
	public static final String E_WKK0003 = "会員情報の更新が失敗しました。";

	public static final String I_WKK0003 = "会員情報の削除が完了しました。";
	public static final String E_WKK0004 = "会員情報の削除が失敗しました。";

	public static final String E_WKK0005 = "会員番号は存在しません。";
